...
def main():
	...
	# Use dataset-level helper to crawl pages and download files (5 per page)
	doj_dataset_helper.pull_doj_dataset_headless(datasets, base_url, output_dir, per_page_limit=5, timeout=30, verbose=verbose, non_interactive=non_interactive)
