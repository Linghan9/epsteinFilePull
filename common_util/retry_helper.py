...
def retry_with_backoff(func, recovery_fun, outputDir: str, verbose: bool, max_retries=3, backoff_factor=1):
    """
    ...
    :param outputDir: The output directory for logging.
    ...
    for attempt in range(1, max_retries + 1):
        try:
            ...
            _log_debug(f"Attempt {attempt} failed with error: {e}. Retrying in {sleep_time} seconds...", outputDir=outputDir, exception=e, verbose=verbose)
